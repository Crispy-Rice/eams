...
class ClassCreate(BaseModel):
    ...
    if_youxiu: Optional[str] = Field(None, max_length=20, description="本班级是否为优秀班级")
    student_num: Optional[int] = Field(0, description="学生数目")
    graduation_year: Optional[int] = Field(None, description="本班学生毕业年份")
