...
#导入业务模块子路由 每个模块一个APIRouter
from com.wanhe.auth.router import router as auth_router #认证


#导入公共模块 日志配置需在启动时加载 供各业务模块 logger 使用
import com.wanhe.common.logging
from com.wanhe.common.exception import register_exception_handlers
